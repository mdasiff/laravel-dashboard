          ...
          <section class="col-lg-12">
            ...
            <div class="card">
                <div class="card-header" style="display:ruby">
                    ...
                    <a href="{{route('admin.locations.index')}}" class="btn btn-primary" style="float:right"><i class="fa fa-list"></i>&nbsp;Locations</a>
                </div>
                <div class="card-body">
                    <form method="POST" action="{{route('admin.locations.store')}}" enctype="multipart/form-data">
                        ...
                        <div class="row">
                          ...
                          <div class="col-6 mb-3">
                              ...
                              <input type="text" name="address_1" class="form-control" value="{{old('address_1')}}" required />
                          </div>
                          <div class="col-6 mb-3">
                              <label for="basic-url">Address 2</label>
                              <input type="text" name="address_2" class="form-control" value="{{old('address_2')}}" required />
                          </div>
                          <div class="col-6 mb-3">
