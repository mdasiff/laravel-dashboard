            ...
            <div class="card">
              ...
              <div class="card-body">
               <!--start form-->
                ...
                <form action="{{ route('admin.product.update', $sc->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                      ...
                      <div class="form-group col-6">
                          ...
                          <select class="form-control" name="category" id="category" required>
                            ...
                            <option {{old('category',$sc->product_category_id)==$category->id?'selected':''}} value="{{$category->id}}">{{$category->name}}</option>
                            @endforeach
                          </select>
