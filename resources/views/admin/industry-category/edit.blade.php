            ...
            <div class="card">
              ...
              <div class="card-body">
               <!--start form-->
                ...
                <form action="{{ route('admin.industry-category.update', $ic->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                      ...
                      <div class="col-6 file-div mb-3">
                          ...
                          <textarea rows="2" id="meta_tag_description" name="meta_tag_description" class="form-control"> {{old('meta_tag_description',$ic->meta_tag_description)}}</textarea> 
                      </div>
