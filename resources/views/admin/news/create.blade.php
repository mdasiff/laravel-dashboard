                ...
                <form action="{{ route('admin.news.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                      ...
                      <div class="form-group col-6">
                          ...
                          <input type="file" class="form-control" id="thumbnail_image" name="image_mobile" accept="image/*" required>
                          @error('image_mobile')
                      ...
                      <div class="form-group col-6">
                          ...
                          <input type="text" class="form-control" name="thumbnail_alt" value ="{{old('thumbnail_alt')}}" />
                          @error('thumbnail_alt')
                              <div class="invalid-feedback d-block">{{ $message }}</div>
                          @enderror
                      </div>
                      ...
                      <div class="form-group col-6">
                          ...
                          <input type="text" class="form-control" id="title" name="title" required placeholder="Enter title" value="{{old('title')}}">
                          @error('title')
                              <div class="invalid-feedback d-block">{{ $message }}</div>
                          @enderror
                      </div>
                      ...
                      <div class="form-group col-6">
                          ...
                          <textarea type="text" class="form-control" id="short_description" name="short_description" placeholder="Enter short_description">{{old('short_description')}}</textarea>
