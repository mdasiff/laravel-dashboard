                ...
                <table class="table table-striped table-bordered">
                  ...
                  @foreach($queries as $key => $query)
                    <tr>
                      ...
                      <td>
                        <a href="{{route('admin.query.webinar.delete',$query->id)}}" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure want to permanently delete this query?')"><i class="fa fa-trash"></i></a>
                      </td>
                    </tr>
                    @endforeach
                  </tbody>
