            ...
            <div class="card">
                ...
                <div class="card-header d-flex justify-content-between">
                    ...
                    <div class="btn-group ml-auto">
                      <a href="{{ route('admin.blog-category.index') }}" class="btn btn-primary"><i class="fas fa-reply-all"></i> Back</a>
                    </div>
                </div>
                    ...
                    <form method="POST" action="{{route('admin.blog-category.update', $category->id)}}" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6 mb-3">
                                ...
                                <input type="number" name="sort" value="{{$category->sort}}" class="form-control" required />
                            </div>
                        </div>
