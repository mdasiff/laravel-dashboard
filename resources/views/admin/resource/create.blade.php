        ...
        @endif
                    ...
                    <div class="row">
                      ...
                      <div class="form-group col-6">
                          ...
                          <input type="file" class="form-control" id="image_mobile" name="image_mobile" accept="image_mobile/*">
                          @error('image_mobile')
                              <div class="invalid-feedback d-block">{{ $message }}</div>
                          @enderror
                      </div>
                      ...
                      <div class="form-group col-6">
                          ...
                          <input type="text" class="form-control" name="home_image_alt" value ="{{old('home_image_alt')}}" />
